...
//rajout de ca par rapport au devoir 5
typedef struct {
    int n;
    double radiusIn;
    double radiusOut;
...
//rajout de ces 3 fonctions par rapport au devoir 5
...
typedef enum { FEM_NO, FEM_XNUM, FEM_YNUM } femRenumType;//fin du rajout
